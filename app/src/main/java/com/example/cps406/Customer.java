...
class Customer {
    ...
    private static void InitTest() {
        ...
        TestUsers.put("Nima", "12345");
        TestUsers.put("Aaryaman", "12345");
    ...
    public void invest(float amount) throws StockException {
        if(amount <= 0)
            throw new StockException("Invalid Investment amount!");
        this.balance += amount;
    }
    public void buy(Stock stock) throws StockException {
        if (balance >= stock.getPrice()) {
            ...
            throw new StockException("You dont have enough balance!");
    }
